...
as a choice for writing user interfaces. There is also a c++ implementation of
the audio graph renderer for ease of creating idiomatic bindings for compiled 
languages (see [Other Languages](elementary.audio)). That means that in an Elementary
